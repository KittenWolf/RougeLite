...
export class Scene {
    ...
    swapGameObjects(from, to) {
        const { point: pointFrom } = from.tile;
        const { point: pointTo } = to.tile;

        [GameObjects.matrix[pointFrom.y][pointFrom.x], GameObjects.matrix[pointTo.y][pointTo.x]] = [to, from];

        [to.tile.point, from.tile.point] = [pointFrom, pointTo];
